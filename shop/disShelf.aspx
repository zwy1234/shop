<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="disShelf.aspx.cs" Inherits="disShelf" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:EShoppingConnectionString %>" SelectCommand="SELECT * FROM [Goods]"></asp:SqlDataSource>
<asp:ListView ID="ListView1" runat="server" DataKeyNames="Goods_id" DataSourceID="SqlDataSource1" GroupItemCount="5"  >
            <AlternatingItemTemplate>
                <td runat="server" style="">
                    <p>

                   <asp:ImageButton ID="Image1" runat="server" ImageUrl='<%# Eval("Goods_images", "~/images/{0}") %>' Width="15%" height="30px" PostBackUrl='<%# Eval("Goods_name","~/GoodsDetails.aspx?goods_id={0}") %>' />
                  ...
                  &nbsp;&nbsp;&nbsp;
                    ...
                    <asp:Button ID="Button1" runat="server" Text="下架"  PostBackUrl='<%# Eval("Goods_id","~/disShelf.aspx?goods_id={0}") %>' OnClick="Button1_Click"/>   
                    </div>
...
<td runat="server" />
            ...
            <ItemTemplate>
                <td runat="server" style=""><p><asp:ImageButton ID="Image1" runat="server" ImageUrl='<%# Eval("Goods_images", "~/images/{0}") %>' Width="15%" height="30px" PostBackUrl='<%# Eval("Goods_name","~/GoodsDetails.aspx?goods_id={0}") %>' /></p>
                    <div>
